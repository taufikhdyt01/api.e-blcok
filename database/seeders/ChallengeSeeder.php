    ...
    public function run()
    {
        $challenges = [
            ...
            [
                ...
                'description' => 'Buatlah fungsi untuk menghitung luas persegi. Fungsi ini menerima satu parameter yaitu sisi (s) dan harus mengembalikan hasil luas persegi (sisi × sisi).',
                'difficulty' => 'easy',
                'category' => 'Geometri',
                'access_type' => 'private',
                'access_code' => 'GEOM101',
                'function_name' => 'hitungLuasPersegi',
                'initial_xml' => '<xml xmlns="https://developers.google.com/blockly/xml">
                    <block type="procedures_defreturn" x="20" y="20">
                        <mutation>
                            <arg name="sisi" varid="789"></arg>
                        </mutation>
                        <field name="NAME">hitungLuasPersegi</field>
                        <comment pinned="false" h="80" w="160">Hitung luas persegi</comment>
                    </block>
                </xml>',
                'hints' => json_encode([
                    'Luas persegi adalah sisi × sisi',
                    'Gunakan blok perkalian untuk menghitung luas',
            ...
            [
                ...
                'description' => 'Buatlah fungsi untuk mengecek apakah sebuah bilangan adalah genap. Fungsi menerima satu parameter bilangan (n) dan mengembalikan true jika genap, false jika ganjil.',
                'difficulty' => 'easy',
                'category' => 'Logika',
                'access_type' => 'private',
                'access_code' => 'LOG101',
                'function_name' => 'cekGenap',
                'initial_xml' => '<xml xmlns="https://developers.google.com/blockly/xml">
                    <block type="procedures_defreturn" x="20" y="20">
                        <mutation>
                            <arg name="n" varid="101"></arg>
                        </mutation>
                        <field name="NAME">cekGenap</field>
                    </block>
                </xml>',
                'hints' => json_encode([
                    'Gunakan operator modulo (%) untuk mengecek sisa bagi',
                    'Bilangan genap adalah bilangan yang habis dibagi 2',
                    'Gunakan blok logika untuk membandingkan hasil modulo'
                ]),
                'constraints' => json_encode([
                    '-1000 ≤ n ≤ 1000',
                    'Input akan selalu berupa bilangan bulat'
            ...
            [
                ...
                'description' => 'Buatlah fungsi untuk menghitung rata-rata dari tiga angka. Fungsi menerima tiga parameter (a, b, c) dan mengembalikan hasil rata-rata.',
                'difficulty' => 'easy',
                'category' => 'Aritmatika',
                'access_type' => 'private',
                'access_code' => 'MATH102',
                'function_name' => 'hitungRataRata',
                'initial_xml' => '<xml xmlns="https://developers.google.com/blockly/xml">
                    <block type="procedures_defreturn" x="20" y="20">
                        <mutation>
                            <arg name="a" varid="201"></arg>
                            <arg name="b" varid="202"></arg>
                            <arg name="c" varid="203"></arg>
                        </mutation>
                        <field name="NAME">hitungRataRata</field>
                    </block>
                </xml>',
                'hints' => json_encode([
                    'Jumlahkan ketiga angka terlebih dahulu',
                    'Bagi hasil penjumlahan dengan 3',
                    'Gunakan operator pembagian untuk mendapatkan rata-rata'
                ]),
                'constraints' => json_encode([
                    '0 ≤ a, b, c ≤ 100',
            ...
            [
                'title' => 'Konversi Suhu',
                'description' => 'Buatlah fungsi untuk mengkonversi suhu dari Celsius ke Fahrenheit. Fungsi menerima satu parameter suhu dalam Celsius dan mengembalikan hasil konversi dalam Fahrenheit.',
                'difficulty' => 'medium',
                'category' => 'Aritmatika',
                'access_type' => 'private',
                'access_code' => 'CONV201',
                'function_name' => 'konversiSuhu',
                'initial_xml' => '<xml xmlns="https://developers.google.com/blockly/xml">
                    <block type="procedures_defreturn" x="20" y="20">
                        <mutation>
                            <arg name="celsius" varid="301"></arg>
                        </mutation>
                        <field name="NAME">konversiSuhu</field>
                    </block>
                </xml>',
                'hints' => json_encode([
                    'Rumus: (C × 9/5) + 32',
                    'Gunakan operator perkalian dan pembagian',
                    'Jangan lupa menambahkan 32 di akhir perhitungan'
                ]),
                'constraints' => json_encode([
                    '-100 ≤ celsius ≤ 100',
                    'Input akan selalu berupa bilangan bulat'
